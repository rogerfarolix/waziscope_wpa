    ...
    <footer class="app-footer">
      <div class="app-footer__inner">
        <span class="app-footer__brand">
          Wazi<em>Scope</em> — par
          <a href="https://roger.nealix.org" target="_blank" rel="noopener">Roger Gnanih</a>
        </span>
        <a href="https://github.com/rogerfarolix/waziscope_wpa" target="_blank" rel="noopener" class="app-footer__gh">
...
.app-footer__brand { line-height: 1.4; }
.app-footer__brand em { font-style: normal; color: var(--mint); }
.app-footer__brand a {
  color: var(--text-hi);
  text-decoration: underline;
  text-underline-offset: 3px;
}
.app-footer__brand a:hover { color: var(--mint); }
.app-footer__gh {
  display: inline-flex;
  align-items: center;
  gap: 6px;
